...
\title{Indexovanie veľkých dát v internete vecí: metódy a využitie}

\date{\footnotesize 5. november 2023}
...
\section{Moj novy slajd}
% príkaz \ssection by vytvoril zvláštný slajd s názvom časti - v krátkych prezentáciách to prekáža, lebo oberá o čas

\begin{frame}[fragile=singleslide]\frametitle{Moj novy slajd}
\begin{itemize}
\item Odrážky na prvej úrovni
\item Odrazka 1. urovne
	\begin{itemize}
	\item 1. odrazka druhej urovne
	\item 2. odrazka druhej urovne
	\end{itemize}
\item Pokračuje prvá úroveň
\end{itemize}
\paragraph{}

    \includegraphics[width=0.3\textwidth]{poziadavky.pdf}
